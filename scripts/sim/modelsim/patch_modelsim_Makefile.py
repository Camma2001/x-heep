...
string_replaced.append('RUN_OPT = '+ "\n" + \
                       ...
                       '    RUN_UPF_OPTIONS := -pa' + "\n" + \
                       'endif'+ "\n\n");
string_replaced.append('EXTRA_OPTIONS ?= -do "do /scratch2/bsc25f1/x-heep/waves.do; run 5000 us" -t 1ps -voptargs=+acc $(VSIM_OPTIONS) $(addprefix -g,$(PARAMETERS)) $(addprefix +,$(PLUSARGS)) $(RUN_UPF_OPTIONS)')
